...
2. Make sure to have sufficient ETH in your user account and get some Rinkeby DAI from [Compound's Rinkeby UI](https://app.compound.finance/) (Supply DAI => Withdraw => Faucet)
